...
// Changelog
changes = [
	"-1.5.1 detailed section now can be accessible from main screen (just click on the streamer name), changed color scheme, changed toolbar's icons, added detailed section in the Following Hub, added caching for the Following Hub, fixed issue with 'refresh' button, fixed position of streamer in the Following Hub, various fixes for HiDPI displays",
